...
The UI was originally built using Gemini 2.5 Pro Experimental, based on USWDS components and styling. It was updated (February 2026) using Github Agents and Claude Opus 4.6 in Antigravity. The frontend code has been refactored to TypeScript with comprehensive test coverage.
